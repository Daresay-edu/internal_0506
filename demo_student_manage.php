					...
					require_once("lib/lib.php");
						switch($_GET["action"]) {
							case "display_by_name":
								...
								$chief_teacher = $_GET["chief_teacher"];
								$assis_teacher = $_GET["assis_teacher"];
								$state = $_GET["state"];
								$way = $_GET["way"];
								...
								echo "<table border='0' width=500px  align='center'>";
									...
									echo "<tr>";
										echo "<td>主教</td>";
										echo "<td>".$chief_teacher."</td>";
									echo "</tr>";
									echo "<tr>";
										echo "<td>助教</td>";
										echo "<td>".$assis_teacher."</td>";
									echo "</tr>";
									echo "<tr>";
										echo "<td>信息来源</td>";
										echo "<td>".$way."</td>";
								...
								echo "</table>";
								echo "<br/><br/>";
								echo "<div style='text-align:center;'><a href='demo_student_manage.php?action=modify&name=".$name."&engname=".$engname."&age=".$age."&gender=".$gender."&phone=".$phone."&school=".$school."&demo_date=".$demo_date."&chief_teacher=".$chief_teacher."&assis_teacher=".$assis_teacher."&state=".$state."&way=".$way."&reception=".$reception."&saleman=".$saleman."&stuid=".$stuid."&join_into=".$join_into."&note=".$note."'><input class='submit' type='button' value='修改'/></a><a href='demo_student_manage.php?action=delete&name=".$name."&engname=".$engname."&from=".$from."&end=".$end."' onClick='return makesure()'><input class='submit' type='button' value='删除'/></a><a href='demo_student_manage.php?action=turn&name=".$name."&engname=".$engname."&age=".$age."&gender=".$gender."&phone=".$phone."&school=".$school."&demo_date=".$demo_date."&chief_teacher=".$chief_teacher."&assis_teacher=".$assis_teacher."&state=".$state."&way=".$way."&saleman=".$saleman."&stuid=".$stuid."&join_into=".$join_into."&note=".$note."'><input class='submit' type='button' value='转正式'/></a><a href='demo_student_manage.php?action=display&from=".$from."&end=".$end."'><input class='submit' type='button' value='返回'/></a></div>";
								echo "<br/><br/>";
								break;
							case "display":
								...
								if (strcmp($state, '已报名') == 0) {
									...
									for ($i; $i < count($data); $i++) {
										echo "<tr>";
											...
											echo "<td>".$data[$i]['chief_teacher']."</td>";
											echo "<td>".$data[$i]['assis_teacher']."</td>";
											echo "<td>".$data[$i]['reception']."</td>";
							...
							case "add":
							 ...
							 $phone, $demo_date, $chief_teacher, $assis_teacher, $way, $state, $reception, $sale, $note); 
							 	if ($errno)
							...
							case "modify":
								...
								echo "<form action='demo_student_manage.php?action=modify_do' method='post'>
									...
									echo "<tr>";
										echo "<td>主教</td>";
										echo "<td><input name='chief_teacher' id='chief_teacher' value='".$chief_teacher."'></td>";
									echo "</tr>";
									echo "<tr>";
										echo "<td>助教</td>";
										echo "<td><input name='assis_teacher' id='assis_teacher' value='".$assis_teacher."'></td>";
									echo "</tr>";
									echo "<tr>";
										echo "<td>信息来源</td>";
									...
									echo "<tr>";
										echo "<td>接待</td>";
										echo "<td><input name='reception' id='reception' value='".$reception."'></td>";
									echo "</tr>";
									echo "<tr>";
										echo "<td>课程顾问</td>";
							...
							case "turn_do":
								...
								echo "<table border='0' width=500px  align='center'>";
									...
									echo "<tr>";
										echo "<td>主教</td>";
										echo "<td>".$row['chief_teacher']."</td>";
									echo "</tr>";
									echo "<tr>";
										echo "<td>助教</td>";
										echo "<td>".$row['assis_teacher']."</td>";
									echo "</tr>";
									echo "<tr>";
										echo "<td>信息来源</td>";
										echo "<td>".$row['way']."</td>";
							...
							case "modify_do":
								...
								list($errno, $row) = demo_student_modify ($oldname, $oldengname, $name, $engname, $age, $gender, $school, $phone, $demo_date, $chief_teacher, $assis_teacher, $way, $state, $reception, $saleman, $stuid, $join_into, $note); 
							 	if ($errno)
