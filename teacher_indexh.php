		...
		<div id="main">
			...
			<div id="content">
				...
				<table border="0" width="700">
					...
					if(!$result){
						//表不存在，创建teacher
						$sql="CREATE TABLE {$table_name} (id INT(20) not null AUTO_INCREMENT,name varchar(32),engname varchar(32),join_time varchar(32),salary varchar(32),note varchar(1000),primary key(id))";
