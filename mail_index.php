			...
			<div id="content">
				...
				<div class="box">
					...
					<div class="vidoes">
                      			<!-- Add Videos -->
                      			<br/>
					<form action="mail_action.php?action=see" method="post">
					   <table border="0" width="700">
					   	...
					   	<tr>
							...
							<td align="right"><input class='field'  style="background-color:#F9EBAE" type="submit" name="send" value="查看课程内容"/></td>
						</tr>
